...
export function Step4PrimaryKeyword() {
  ...
  React.useEffect(() => {
    const fetchKeywords = async () => {
      ...
      setLoading(true);
      try {
        // Use apiService to fetch primary keywords based on the topic
        ...
        // Set a fallback keyword if the API fails
          ...
          <div className="divide-y divide-gray-100 max-h-80 overflow-y-auto">
            {loading ? (
              <div className="flex flex-col items-center justify-center p-8">
                ...
                <p className="text-gray-600">Loading keywords from search data...</p>
              </div>
